...
// TODO: change your mapings to match appropriate keybinds.
...
// LATER TODO: This takes float values depending on how much you push the joystick. It doesn't apply anymore.
/**
...
function ToggleKeyboardPanel({ context }: { context: PanelExtensionContext }): React.JSX.Element {
  ...
  const [state, setState] = useState<ToggleKeyboardPanelState>({
    ...
    joystickConnected: false, // TODO: We don't need this
   ...
   * @param transformedKeyboInputs A TransformedJoystickInputs object used to create the desired power message
   */
  ...
  }, [state.joystickEnabled, toggleKeyboard]);

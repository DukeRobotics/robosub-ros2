...
class TorpedoTargetDetector2026(Node):
    ...
    def __init__(self) -> None:
        ...
        self.hsv_filtered_pub = self.create_publisher(Image, '/cv/front_usb/torpedo0/hsv_filtered', 1)
        self.contour_image_pub = self.create_publisher(Image, '/cv/front_usb/torpedo0/contour_image', 1)
        self.contour_image_with_bbox_pub = self.create_publisher(Image, '/cv/front_usb/torpedo0/detections', 1)
        self.largest_bbox_pub = self.create_publisher(
            CVObject, '/cv/front_usb/torpedo0/largest_target/bounding_box', 1,
        )

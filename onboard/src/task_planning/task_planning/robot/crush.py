...
async def main(self: Task) -> Task[None, None, None]:
    ...
    tasks = [
        ...
        # comp_tasks.initial_submerge(-0.4, z_tolerance=0.15, enable_controls_flag=True, timeout=10, parent=self),
        ...
        # move_tasks.move_with_directions([(2, 0, 0)], depth_level=-0.7, correct_depth=True, correct_yaw=True, parent=self),
        # move_tasks.move_with_directions([(2, 0, 0)], depth_level=-0.7, correct_depth=True, correct_yaw=True, parent=self),
        ...
        # SONAR
        # comp_tasks.initial_submerge(-0.3, z_tolerance=0.15, enable_controls_flag=True, timeout=10, parent=self),
        # comp_tasks.orient_to_wall(start_angle=-15.0, end_angle=15.0, distance=20.0, parent=self),

        # comp_tasks.initial_submerge(-1.0, z_tolerance=0.15, enable_controls_flag=True, timeout=10, parent=self),
        # comp_tasks.octagon_task(direction=1, parent = self),

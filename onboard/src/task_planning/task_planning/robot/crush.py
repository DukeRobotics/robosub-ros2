...
async def main(self: Task) -> Task[None, None, None]:
    ...
    tasks = [
        comp_tasks.initial_submerge(0.6, enable_controls_flag=True, timeout=15, parent=self),
        sonar_tasks.rotate_to_normal(start_angle=-30, end_angle=30, scan_distance=6, yaw_threshold=math.pi/48, parent=self),

...
async def main(self: Task) -> Task[None, None, None]:
    ...
    tasks = [
        ...
        # comp_tasks.initial_submerge(0.5, enable_controls_flag=True, timeout=15, parent=self),
        # sonar_tasks.rotate_to_normal(start_angle=-20, end_angle=20, scan_distance=6, yaw_threshold=math.pi/24, parent=self),
        # ivc_tasks.ivc_send(IVCMessageType.CRUSH_TEST, parent=self),

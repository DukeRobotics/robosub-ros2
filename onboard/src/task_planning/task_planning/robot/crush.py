...
async def main(self: Task) -> Task[None, None, None]:
    ...
    tasks = [
        ...
        # move_tasks.move_to_pose_local(geometry_utils.create_pose(0, 0, -0.7, 0, 0, 0), parent = self),
        # comp_tasks.octagon_task(direction=1, parent=self),
        comp_tasks.coin_flip(parent=self, enable_same_direction=False),
        move_tasks.move_with_directions([(10, 0, 0)], depth_level=-0.7, correct_depth=True, correct_yaw=True, parent=self),

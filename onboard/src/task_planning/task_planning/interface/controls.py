...
class Controls:
    ...
    def set_axis_control_type(self, *, x: ControlTypes | None = None, y: ControlTypes | None = None,
                              z: ControlTypes | None = None, roll: ControlTypes | None = None,
                              pitch: ControlTypes | None = None, yaw: ControlTypes | None = None) -> None:
        """

...
class ROSMessageHandler(jsonpickle.handlers.BaseHandler):
    ...
    def flatten(self, obj: Any, data: dict) -> dict:  # noqa: ANN401 - obj is any ROS message type
    ...
    def restore(self, obj: dict) -> Any:  # noqa: ANN401 - the restored value is any ROS message type
